...
- **predictive-analytics-qa-medical-devices** – Literature review on predictive analytics in medical‑device QA  
- **python-stock-analysis** – Full analytical workflow using Pandas, Matplotlib, and scikit‑learn  
- **nosql-data-analysis-tutorials** – MongoDB CMS modelling and Neo4j fraud‑detection graph analytics  
- **faulty-medical-devices-analysis** – Python analysis of medical device event and defect data  

---

*Thank you for viewing this repository. Feedback and improvement suggestions are always welcome.*
